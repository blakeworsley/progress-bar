...
ProgressBar.propTypes = {
  width: React.PropTypes.number.isRequired, //if a propType is passed in, it has to be a number
  height: React.PropTypes.number.inRequired,
  percentage: React.PropTypes.number.inRequired
}
